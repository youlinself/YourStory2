...
const Header: React.FC = () => {
  ...
  return (
    <header className="bg-apple-parchment/80 backdrop-blur-xl border-b border-apple-hairline/50 sticky top-0 z-40">
      <div className="flex items-center justify-between px-6 h-[52px]">
        <div className="flex items-center gap-6">
          <button
            onClick={() => navigate('/')}
            className="text-apple-body-strong text-apple-ink hover:text-apple-primary transition-colors"
          >
            个人自传
          </button>
          {pageTitle && (
            <>
              ...
              <span className="text-apple-tagline text-apple-ink">
                {pageTitle}
              </span>
            </>
          )}
