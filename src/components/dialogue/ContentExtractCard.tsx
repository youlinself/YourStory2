...
const ContentExtractCard: React.FC<ContentExtractCardProps> = ({
  ...
  return (
    <div className="mt-3 border border-brand-primary/20 rounded-xl bg-brand-primary-subtle p-4 animate-slide-up">
      {/* 标题栏 */}
      <div className="flex items-center gap-2 mb-3">
        ...
        <span className="text-subheading text-brand-primary">AI 提取的自传内容</span>
          ...
          {isEditing ? (
            <>
              <button
                ...
                className="flex-1 px-3 py-1.5 rounded-lg bg-brand-primary text-white text-xs font-medium hover:bg-brand-primary-hover transition-colors"
              >
                保存修改
              </button>
              <button
