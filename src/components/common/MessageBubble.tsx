...
const MessageBubble: React.FC<MessageBubbleProps> = ({
  ...
  if (isUser) {
    return (
      <div
        className={`message-row ${className}`}
        data-user="true"
      ...
      >
        <div className="flex flex-col items-end gap-1.5 max-w-[75%]">
          <div className="relative group">
            ...
            {/* Actions - displayed on the left side of the bubble */}
            <div
              className="message-actions"
              data-position="left"
            >
              {showActions && !isStreaming && onEdit && (
                <button
                  onClick={handleEdit}
              ...
              {showActions && !isStreaming && onDelete && (
                <button
      ...
      <div className="flex gap-3 max-w-[80%]">
        ...
        <div className="flex flex-col gap-1.5">
          <div className="relative group">
            ...
            {/* Actions - displayed on the right side of the bubble */}
            <div
              className="message-actions"
              data-position="right"
            >
